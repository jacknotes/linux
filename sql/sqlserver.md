...
--添加相同SID的数据库用户
CREATE LOGIN cachedproject WITH PASSWORD = 'password', SID = 0x72DAF5292DFDFF418B4E22245909F75A,DEFAULT_DATABASE =master, CHECK_POLICY =OFF
CREATE LOGIN callcenter WITH PASSWORD = 'password', SID = 0x4736E0449658F14197FCBD864C2D24CF,DEFAULT_DATABASE =master, CHECK_POLICY =OFF
CREATE LOGIN commonsupersa WITH PASSWORD = 'password', SID = 0xA366E3854913B24C81BAFF64D49B7C3B,DEFAULT_DATABASE =master, CHECK_POLICY =OFF
CREATE LOGIN commonuser WITH PASSWORD = 'password', SID = 0x5AAD19BA7E2C3441A030C67BFD024752,DEFAULT_DATABASE =master, CHECK_POLICY =OFF
CREATE LOGIN dbbackup WITH PASSWORD = 'password', SID = 0xE9E835A237473C4CB0F77021942E0FF9,DEFAULT_DATABASE =master, CHECK_POLICY =OFF
CREATE LOGIN etermproduct WITH PASSWORD = 'password', SID = 0xA160B0EDF4D04446936315F9FD2250B8,DEFAULT_DATABASE =master, CHECK_POLICY =OFF
