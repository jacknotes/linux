...
select store.gid                     --店铺gid
      ...
      ,sum(stkoutdtl.CRTLPRC*stkoutdtl.qty)--配往门店金额
      ,stkout.OCRDATE                --发生日期
      ,stkout.wrh                    --仓位号
      ,wrh.name                      --仓位
      ,stkout.filler                 --填单人
...
where store.gid = stkout.client
  ...
  and sort.code in ('23','27')
  and goods.gid in(3031358,3031359,3026234,3031360,3032838)
...
select store.gid                     --店铺gid
      ...
      ,-sum(STKOUTBCKdtl.qty*STKOUTBCKdtl.CRTLPRC)            --配往门店金额
...
select store.gid                     --店铺gid
      ...
      ,sum(ALCDIFFdtl.qty*ALCDIFFdtl.CRTLPRC)          --配货金额
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR><=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2017.03.09</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2017.03.09</SGLINEITEM>
