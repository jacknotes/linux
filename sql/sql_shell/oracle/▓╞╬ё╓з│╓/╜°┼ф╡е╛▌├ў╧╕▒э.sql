...
begin
  ...
  if conType is null or conType = '自营进' then
    --自营进
    insert into hdtmp_hd_standard_temp(vdrgid,gdgid,var,var_2,qty,qty_0,amt,amt_0,rtotal,storegid,var_0,fildate,cls)
         select m.vendor,d.gdgid,d.munit,d.qpcstr,sum(d.qty),sum(d.qty/d.qpc),round(d.price/d.qpc,4),d.price,sum(d.total),m.wrh,m.psr,trunc(l.time),'自营进'
       ...
       group by m.vendor,d.gdgid,d.munit,d.qpcstr,round(d.price/d.qpc,4),d.price,m.wrh,m.psr,trunc(l.time);
    commit;
  ...
  if conType is null or conType = '直配出' then   
    --直配出货单
    insert into hdtmp_hd_standard_temp(vdrgid,gdgid,var,var_2,qty,qty_0,amt,amt_0,rtotal,storegid,var_0,VAR_1,fildate,cls)
         select m.vendor,d.gdgid,d.munit,d.qpcstr,sum(d.qty),sum(d.qty/d.qpc),round(d.price/d.qpc,4),d.price,sum(d.total),m.receiver,M.PSR,m.filler,trunc(l.time),'直配出'
          ...
          where m.num = d.num and m.cls = d.cls
            ...
            and l.time >= vbegindate
            and l.time < venddate + 1
       group by m.vendor,d.gdgid,d.munit,d.qpcstr,round(d.price/d.qpc,4),d.price,m.receiver,M.PSR,m.filler,trunc(l.time);
    commit;
  ...
  if conType is null or conType = '统配出' then   
    --统配出
    insert into hdtmp_hd_standard_temp(vdrgid,gdgid,var,var_2,qty,qty_0,amt,amt_0,rtotal,storegid,var_1,fildate,cls)
         select 1,d.gdgid,d.munit,d.qpcstr,sum(d.qty),sum(d.qty/d.qpc),round(d.price/d.qpc,4),d.price,sum(d.total),m.client,m.filler,trunc(l.time),'统配出'
          ...
          where m.num = d.num and m.cls = d.cls
            ...
            and l.time >= vbegindate
            and l.time < venddate + 1
       group by 1,d.gdgid,d.munit,d.qpcstr,round(d.price/d.qpc,4),d.price,m.client,m.filler,trunc(l.time);
    commit;   
    --统配出退
    insert into hdtmp_hd_standard_temp(vdrgid,gdgid,var,var_2,qty,qty_0,amt,amt_0,rtotal,storegid,var_1,fildate,cls)
         select 1,d.gdgid,d.munit,d.qpcstr,-sum(d.qty),-sum(d.qty/d.qpc),round(d.price/d.qpc,4),d.price,-sum(d.total),m.client,m.filler,trunc(l.time),'统配出'
    ...
    --配货差异
    insert into hdtmp_hd_standard_temp(vdrgid,gdgid,var,var_2,qty,qty_0,amt,amt_0,rtotal,storegid,var_1,fildate,cls)
         Select 1,d.gdgid,d.munit,d.gdqpcstr,sum(d.qty),sum(d.qty/d.gdqpc),round(d.price/d.gdqpc,4),d.price,sum(d.total),m.store,m.createoper,trunc(l.time),'统配出'
          ...
          where m.num = d.num and m.cls = d.cls
            ...
            and l.time >= vbegindate
            and l.time < venddate + 1
       group by d.gdgid,d.munit,d.gdqpcstr,round(d.price/d.gdqpc,4),d.price,m.store,m.createoper,trunc(l.time);
    commit;
  end if;
...
<COLUMNLIST>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>hdtmp_hd_standard.var</COLUMN>
    <TITLE>单位</TITLE>
    <FIELDTYPE>1</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>hdtmp_hd_standard.var_2</COLUMN>
    <TITLE>规格</TITLE>
    <FIELDTYPE>1</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION>SUM</AGGREGATION>
    <COLUMN>hdtmp_hd_standard.qty_0</COLUMN>
    <TITLE>规格数量</TITLE>
    <FIELDTYPE>6</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION>SUM</GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>hdtmp_hd_standard.amt</COLUMN>
    <TITLE>单价</TITLE>
    <FIELDTYPE>6</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>hdtmp_hd_standard.amt_0</COLUMN>
    <TITLE>规格单价</TITLE>
    <FIELDTYPE>6</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
