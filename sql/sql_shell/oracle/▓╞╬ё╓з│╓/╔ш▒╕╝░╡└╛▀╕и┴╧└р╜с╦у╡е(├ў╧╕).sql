...
select store.gid                     --店铺gid
      ...
      ,sum(stkoutdtl.CAMT+stkoutdtl.CTAX)           --成本金额
      
      ,sum(stkoutdtl.CRTOTAL) --门店售价金额
...
select store.gid                     --店铺gid
      ...
      ,-sum(STKOUTBCKdtl.CAMT+STKOUTBCKdtl.CTAX)           --成本金额
...
<COLUMNLIST>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>case when tmp_test2.char20='01' then '木槿生活'
     when tmp_test2.char20='02' then 'MUMUSO FAMILY'
else '未知' end
</COLUMN>
    <TITLE>品牌</TITLE>
    <FIELDTYPE>1</FIELDTYPE>
