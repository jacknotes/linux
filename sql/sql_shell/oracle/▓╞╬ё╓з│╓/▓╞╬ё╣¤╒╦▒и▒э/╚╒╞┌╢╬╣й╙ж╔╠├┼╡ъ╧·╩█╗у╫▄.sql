...
begin
  ...
  insert into hdtmp_SalDrpt(cls,orgkey,pdkey,vdrkey,brdkey,fildate,
                            saleqty,saleamt,saletax,salecamt,salectax)
     select null,r.snd,'',r.billto,null,r.fildate/*nvl(vdate,vbegdate)*/,
    ...
    from sdrpts r
    where r.cls in ('零售','零售退','批发','批发退','成本差异','成本调整')
      and (r.ocrdate >= trunc(sysdate))
      and (r.fildate < venddate or venddate is null)
      and (r.fildate >= vbegdate or vbegdate is null)
    group by r.snd,r.billto,r.fildate/*nvl(vdate,vbegdate)*/; 
   commit;
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2011.02.15</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
  ...
  <CRITERIAITEM>
    ...
    <PICKNAME>
      ...
      <PICKNAMEITEM>联销商</PICKNAMEITEM>
    </PICKNAME>
    <PICKVALUE>
      <PICKVALUEITEM>经销商</PICKVALUEITEM>
      <PICKVALUEITEM>联销商</PICKVALUEITEM>
    </PICKVALUE>
    <DEFAULTVALUE></DEFAULTVALUE>
    <ISREQUIRED>FALSE</ISREQUIRED>
    <WIDTH>0</WIDTH>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2011.02.15</SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM>0001</SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM>联销商</SGLINEITEM>
  </LINE>
  <LINE>
