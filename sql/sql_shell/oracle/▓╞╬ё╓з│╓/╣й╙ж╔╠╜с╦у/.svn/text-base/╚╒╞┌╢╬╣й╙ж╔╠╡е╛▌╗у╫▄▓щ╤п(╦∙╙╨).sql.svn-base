...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <PICKNAME>
      ...
      <PICKNAMEITEM>预付款类</PICKNAMEITEM>
      <PICKNAMEITEM>费用类</PICKNAMEITEM>
      <PICKNAMEITEM>压库类</PICKNAMEITEM>
      <PICKNAMEITEM>非货款类</PICKNAMEITEM>
      <PICKNAMEITEM>付款单</PICKNAMEITEM>
    </PICKNAME>
    <PICKVALUE>
      <PICKVALUEITEM>自营进,直配出,自营进退,直配出退</PICKVALUEITEM>
      <PICKVALUEITEM>预付付款单,预付还款单</PICKVALUEITEM>
      <PICKVALUEITEM>费用单,交款单,退款单</PICKVALUEITEM>
      <PICKVALUEITEM>压库收款单,压库付款单</PICKVALUEITEM>
      <PICKVALUEITEM>预付付款单,预付还款单,费用单,交款单,退款单,压库收款单,压库付款单,付款单</PICKVALUEITEM>
      <PICKVALUEITEM>付款单</PICKVALUEITEM>
    </PICKVALUE>
    <DEFAULTVALUE></DEFAULTVALUE>
    <ISREQUIRED>FALSE</ISREQUIRED>
    <WIDTH>0</WIDTH>
