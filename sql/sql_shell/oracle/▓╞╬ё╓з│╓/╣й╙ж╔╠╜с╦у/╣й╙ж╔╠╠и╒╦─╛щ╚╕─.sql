...
begin
  delete from HD_REPORT.H4RTMP_sort;
...
-------------供应商对应商品类别 2014-12-17 by lsb
insert into H4RTMP_sort 
select distinct  substr(code,1,2) ,VDRGID from goods ;

update H4RTMP_sort
set sort = 01
 where vdrgid in (select a.vdrgid vdrgid from H4RTMP_sort A,H4RTMP_sort b where a.vdrgid = b. vdrgid and a.sort<>b.sort and a.sort < '20' group by a.vdrgid);
 
 update H4RTMP_sort
set sort = 30
 where vdrgid in (select a.vdrgid vdrgid from H4RTMP_sort A,H4RTMP_sort b where a.vdrgid = b. vdrgid and a.sort<>b.sort and a.sort >= '20' group by a.vdrgid ) ;

-----------------供应商订单明细 2014-12-3 by lishibai
 INSERT INTO H4RTMP_CWTZ(CLS,NUM,SETTLENO,VENDOR,FILDATE,ORDAMT,
  stat)
  select s.cls,s.num,s.settleno,s.VENDOR,l.time,s.total,'0'
  from ord s , ordlog l
  where
     s.num=l.num
     and s.cls=l.cls 
     and l.stat = decode(s.stat,200,100,s.stat) 
     and l.stat not in ('110','1700') 
     and l.modifier <> '日结程序'
        and l.time < venddate 
        and l.time >= vbgndata 
        ORDER BY l.time;
...
-----------------供应商进/退货明细 
 ...
 --- 按日期统计供应商的账款情况
  INSERT INTO H4RTMP_CWTZ_TMP(VENDOR, FILDATE , ORDAMT , TOTAL , SALETOTAL ,
    ...
    SELECT VENDOR, FILDATE ,SUM(ORDAMT) OVER (PARTITION BY VENDOR ORDER BY FILDATE
           RANGE UNBOUNDED PRECEDING) VORDTOTAL,----供应商订单
      SUM(STKINAMT) OVER (PARTITION BY VENDOR ORDER BY FILDATE
  ...
  INSERT INTO H4RTMP_CWTZ(CLS,VENDOR,FILDATE,ORDAMT,STKINAMT,STKBCKAMT,PREPAY,PREPAYBCK,FEE,DPTBILL,VDRPAYTOTAL,VDRPAYBCKTOTAL,PAY,TAX,STAT,PAY_SALE,PAY_FEE,PAY_PREPAY)
  select '合计',VENDOR,vbgndata,SUM(ORDAMT),SUM(STKINAMT),SUM(STKBCKAMT),SUM(PREPAY),SUM(PREPAYBCK),sum(FEE),SUM(DPTBILL),SUM(VDRPAY),
  ...
  insert into H4RTMP_CWTZ01(CLS,PVICLS,NUM,PVINUM,SETTLENO,VENDOR,FILDATE,PAYDATE,TOTAL,TAX,ORDNUM,STAT,PAYMODE,GDGID
    ...
    ,VDRPAYBCK,VDRPAYTOTAL,VDRPAYBCKTOTAL,BGNDATE,ENDDATE,LINE,PAY_SALETOTAL,PAY_FEETOTAL,PAY_PREPAYTOTAL,PAY_SALE,PAY_FEE,PAY_PREPAY,ORDAMT) 
...
<TABLELIST>
  ...
  <TABLEITEM>
    <TABLE>HD_REPORT.H4RTMP_sort</TABLE>
    <ALIAS>HD_REPORT_H4RTMP_sort</ALIAS>
    <INDEXNAME></INDEXNAME>
    <INDEXMETHOD></INDEXMETHOD>
  </TABLEITEM>
</TABLELIST>
<JOINLIST>
  ...
  <JOINITEM>
    <LEFT>HD_REPORT_H4RTMP_sort.vdrgid</LEFT>
    <OPERATOR>=</OPERATOR>
    <RIGHT>VENDORH.GID</RIGHT>
  </JOINITEM>
</JOINLIST>
<COLUMNLIST>
  ...
  <COLUMNITEM>
    ...
    <COLUMN>H4RTMP_CWTZ.ORDAMT</COLUMN>
    <TITLE>订货金额</TITLE>
  ...
  <COLUMNITEM>
    <AGGREGATION>SUM</AGGREGATION>
    <COLUMN>H4RTMP_CWTZ.DPTBILL</COLUMN>
    <TITLE>压库金额总额</TITLE>
    <FIELDTYPE>0</FIELDTYPE>
    <VISIBLE>FALSE</VISIBLE>
    <GAGGREGATION>SUM</GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION>SUM</AGGREGATION>
    <COLUMN>H4RTMP_CWTZ.VDRPAYTOTAL</COLUMN>
    <TITLE>交款额</TITLE>
    <FIELDTYPE>0</FIELDTYPE>
    <VISIBLE>FALSE</VISIBLE>
    <GAGGREGATION>SUM</GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION>SUM</AGGREGATION>
    <COLUMN>H4RTMP_CWTZ.VDRPAYBCKTOTAL</COLUMN>
    <TITLE>交款退款额</TITLE>
    <FIELDTYPE>0</FIELDTYPE>
    <VISIBLE>FALSE</VISIBLE>
    <GAGGREGATION>SUM</GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION>SUM</AGGREGATION>
    <COLUMN>H4RTMP_CWTZ.PAY_FEE</COLUMN>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>HD_REPORT_H4RTMP_sort.sort</COLUMN>
    <TITLE>类别</TITLE>
    <FIELDTYPE>0</FIELDTYPE>
    <VISIBLE>FALSE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR><=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2014.12.31</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
  ...
  <CRITERIAITEM>
    <LEFT>HD_REPORT_H4RTMP_sort.sort</LEFT>
    <OPERATOR>>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2014.12.31</SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM>19</SGLINEITEM>
  </LINE>
  <LINE>
