...
hdtmp_SalDrpt.salectax))/sum(hdtmp_SalDrpt.saleamt + hdtmp_SalDrpt.saletax) )
  ...
  <COLUMNITEM>
    <AGGREGATION>SUM</AGGREGATION>
    <COLUMN>decode((select sum((p.saleamt + p.saletax) - (p.salecamt + p.salectax)) from hdtmp_SalDrpt p where p.orgkey=hdtmp_SalDrpt.orgkey),0,0,
((hdtmp_SalDrpt.saleamt + hdtmp_SalDrpt.saletax) - (hdtmp_SalDrpt.salecamt + hdtmp_SalDrpt.salectax))/
(select sum((p.saleamt + p.saletax) - (p.salecamt + p.salectax)) from hdtmp_SalDrpt p where p.orgkey=hdtmp_SalDrpt.orgkey)
)
</COLUMN>
    <TITLE>毛利额占比</TITLE>
    <FIELDTYPE>6</FIELDTYPE>
  ...
  <COLUMNITEM>
    <AGGREGATION>SUM</AGGREGATION>
    <COLUMN>decode((select sum(d.saleamt + d.saletax) from hdtmp_SalDrpt d where d.orgkey=hdtmp_SalDrpt.orgkey),0,0,
(hdtmp_SalDrpt.saleamt + hdtmp_SalDrpt.saletax)/
(select sum(d.saleamt + d.saletax) from hdtmp_SalDrpt d where d.orgkey=hdtmp_SalDrpt.orgkey)
)</COLUMN>
    <TITLE>零售额占比</TITLE>
    <FIELDTYPE>6</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR><</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2015.06.29</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2015.06.29</SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
