...
select store.gid
      ...
      ,sum((decode(sdrpts.cls,'零售',1,'批发',1,'成本差异',1,'成本调整',1,-1)*sdrpts.qty)*goodsh.invprc) saliamt
      ,Bfiledate
      ,Efiledate
 from sdrpts , goodsh ,store
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR>>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2015.08.13</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2015.08.13</SGLINEITEM>
    <SGLINEITEM>2015.08.13</SGLINEITEM>
