...
begin
  ...
  insert into tmp_test2
    ...
    select m.num,
           ...
           Srt.csname,
           Srt.dsname,
           sum(dtl.camt + dtl.ctax) Total, ---总仓自营进货成本
           sum(dtl.total) AMT, ---总仓自营进货总额
           BDate,
           EDate - 1
      from STKIN M, STKINdtl dtl, Goods G, h4v_goodssort Srt, STKINLOG LOG
     where M.Num = dtl.num
       and M.Cls = dtl.cls
       and dtl.gdgid = G.Gid
       and G.Gid = Srt.gid
    ...
    select m.num,
           ...
           Srt.csname,
           Srt.dsname,
           -sum(dtl.camt + dtl.ctax) Total, ---总仓退货成本
           -sum(dtl.total) AMT, ---总仓退货总额
           BDate,
           EDate - 1
      from STKINBCK      M,
           STKINBCKdtl   dtl,
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR>>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2016.07.01</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR><</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2016.08.01</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2016.07.01</SGLINEITEM>
    <SGLINEITEM>2016.08.01</SGLINEITEM>
  </LINE>
  <LINE>
