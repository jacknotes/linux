...
insert into hdtmp_SalDrptS(cls,pdkey,vdrkey,brdkey,fildate,brand,BRANDNAME,
                            saleqty,saleamt,saletax,salecamt,salectax)
     select null,r.gdgid,null,null,nvl(vdate,vbegdate),b.code,b.name,
...
select cls,pdkey,vdrkey,brdkey,fildate,brand,BRANDNAME,
sum(saleqty),sum(saleamt),sum(saletax),sum(salecamt),sum(salectax)
from hdtmp_SalDrptS 
group by cls,pdkey,vdrkey,brdkey,fildate,brand,BRANDNAME;
commit;
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR>>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2015.02.08</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2015.02.08</SGLINEITEM>
...
<DXDBGRIDITEM>
  ...
  <DXFILTERNAME>I</DXFILTERNAME>
  <DXFILTERTYPE>NUMBER</DXFILTERTYPE>
  <DXFILTERLIST>
  </DXFILTERLIST>
