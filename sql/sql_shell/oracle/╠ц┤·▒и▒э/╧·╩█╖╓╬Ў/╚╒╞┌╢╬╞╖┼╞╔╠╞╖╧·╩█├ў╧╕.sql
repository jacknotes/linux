...
begin
  ...
  insert into hdtmp_SalDrpt(cls,orgkey,pdkey,vdrkey,brdkey,fildate,
    ...
    select null,null,r.pdkey,null,b.code,nvl(vdate,vbegdate),
    ...
    group by r.pdkey,b.code,nvl(vdate,vbegdate);
  
   commit;

 insert into hdtmp_SalDrpt(cls,orgkey,pdkey,vdrkey,brdkey,fildate,
                            saleqty,saleamt,saletax,salecamt,salectax)
    select null,null,r.gdgid,null,b.code,nvl(vdate,vbegdate),
    ...
    from sdrpts r,goodsh g,brand b 
      ...
      and b.code like vbrandcode
      and (r.fildate = vdate or vdate is null)
    group by r.gdgid,b.code,nvl(vdate,vbegdate); 
  commit;
end;
</BEFORERUN>
<AFTERRUN>
