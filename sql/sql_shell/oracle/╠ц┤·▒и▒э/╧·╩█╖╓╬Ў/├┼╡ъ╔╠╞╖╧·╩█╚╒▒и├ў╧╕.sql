...
and e.code = VUSERCODE;
  ...
  insert into hdtmp_SalDrpt(cls,orgkey,pdkey,vdrkey,brdkey,fildate,
    ...
    select null,r.orgkey,r.pdkey,null,b.code,r.fildate,
    ...
    from rpt_storesaldrpt r,goodsh g,store s,brand b
    where r.pdkey = g.gid
      and g.brand = b.code(+)
      and r.orgkey = s.gid
    ...
    group by r.orgkey,r.pdkey,b.code,r.fildate;

   insert into hdtmp_SalDrpt(cls,orgkey,pdkey,vdrkey,brdkey,fildate,
                            saleqty,saleamt,saletax,salecamt,salectax)
     select null,r.snd,r.gdgid,null,b.code,r.fildate,
    ...
    from sdrpts r,goodsh g,store s,brand b
    where r.gdgid = g.gid 
      and g.brand = b.code(+)
      and r.snd = s.gid 
      -- and r.qty <> 0
      ...
      and (g.sort like vsort or vsort is null)
      and (g.code like vgdcode or vgdcode is null)
    group by r.snd,r.gdgid,b.code,r.fildate; 
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR><</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2015.04.11</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2015.04.11</SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
