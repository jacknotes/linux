...
begin
  ...
  select case when instr(vstorecode,',')>0 then '' else vstorecode end into vstorecode from dual;
  ...
  insert into hdtmp_SalDrpt(cls,orgkey,pdkey,vdrkey,brdkey,fildate,
    ...
    select null,r.orgkey,null,null,null,nvl(r.fildate,vbegdate),
     ...
     from rpt_storectgsaldrpt r,store s
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR>>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2016.11.04</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR><</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2016.11.05</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2016.11.04</SGLINEITEM>
    <SGLINEITEM>2016.11.05</SGLINEITEM>
...
<NCRITERIAS>
  ...
  <NCRITERIALIST>
    <NEXTQUERY>门店日期段销售汇总.sql</NEXTQUERY>
    <NCRITERIAITEM>
      <LEFT>记帐日期等于</LEFT>
      <RIGHT>记帐日期</RIGHT>
    </NCRITERIAITEM>
  ...
  <NCRITERIALIST>
    <NEXTQUERY>日期段类别销售汇总(大类).sql</NEXTQUERY>
    <NCRITERIAITEM>
      <LEFT>记帐日期等于</LEFT>
      <RIGHT>记帐日期</RIGHT>
    </NCRITERIAITEM>
