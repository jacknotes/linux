...
begin
 ...
 insert into hdtmp_SalDrpt(cls,orgkey,pdkey,vdrkey,brdkey,fildate,
                            saleqty,saleamt,saletax,salecamt,salectax)
     select null,r.snd,r.gdgid,null,null,nvl(vdate,vbegdate),
           sum(decode(r.cls,'零售',1,'批发',1,-1)*r.qty),sum(decode(r.cls,
'零售',1,'批发',1,-1)*r.amt),
           sum(decode(r.cls,'零售',1,'批发',1,-1)*r.tax),
           sum(decode(r.cls,'零售',1,'批发',1,-1)*r.iamt),sum(decode(r.cls,
'零售',1,'批发',1,-1)*r.itax)          
    from sdrpts r,goodsh g,store s
    where r.gdgid = g.gid 
      and r.snd = s.gid 
      and r.qty <> 0
      and r.cls in ( '零售','零售退','批发','批发退')
      ...
      and (g.sort like vsort or vsort is null)
      and (g.code like vgdcode or vgdcode is null)
    group by r.snd,r.gdgid,nvl(vdate,vbegdate);   
   commit;
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR>>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2011.01.21</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR><</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2011.01.22</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2011.01.21</SGLINEITEM>
    <SGLINEITEM>2011.01.22</SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
...
<CHECKLIST>
  <CAPTION>
    <CAPTIONITEM>美食林考核毛利(剔除0毛利和服务项目)</CAPTIONITEM>
  </CAPTION>
  <EXPRESSION>
    <EXPRESSIONITEM>(hdtmp_SalDrpt.saleamt + hdtmp_SalDrpt.saletax) - (hdtmp_SalDrpt.salecamt + hdtmp_SalDrpt.salectax) <> 0 AND GOODSH.SORT NOT LIKE '26%'</EXPRESSIONITEM>
  </EXPRESSION>
  <CHECKED>
