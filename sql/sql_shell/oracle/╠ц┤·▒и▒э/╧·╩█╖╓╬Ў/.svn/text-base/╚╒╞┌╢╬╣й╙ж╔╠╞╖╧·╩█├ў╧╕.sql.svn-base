...
begin
  ...
  insert into hdtmp_SalDrpt(cls,orgkey,pdkey,vdrkey,brdkey,fildate,
    ...
    select null,null,r.pdkey,v.gid,null,nvl(vdate,vbegdate),
    ...
    from rpt_vdrsaldrpt r,goodsh g,vendorh v 
    where r.pdkey = g.gid 
      and r.vdrkey = v.gid
   ...
   --   and r.saleqty <> 0
    ...
    group by r.pdkey,v.gid,nvl(vdate,vbegdate);

   insert into hdtmp_SalDrpt(cls,orgkey,pdkey,vdrkey,brdkey,fildate,
                            saleqty,saleamt,saletax,salecamt,salectax)
     select null,'',r.gdgid,v.gid,null,nvl(r.fildate,vbegdate),
    ...
    from sdrpts r,goodsh g,vendorh v
    where r.gdgid = g.gid 
      and r.vdrgid = v.gid
      ...
      and (r.fildate >= vbegdate or vbegdate is null)
      and v.code like vendorcode||'%'
    group by r.gdgid,v.gid,nvl(r.fildate,vbegdate); 
...
<JOINLIST>
  ...
  <JOINITEM>
    ...
    <OPERATOR>=</OPERATOR>
    <RIGHT>hdtmp_SalDrpt.vdrkey</RIGHT>
  </JOINITEM>
</JOINLIST>
<COLUMNLIST>
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR>>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2012.11.27</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR><</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2012.11.28</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2012.11.27</SGLINEITEM>
    <SGLINEITEM>2012.11.28</SGLINEITEM>
