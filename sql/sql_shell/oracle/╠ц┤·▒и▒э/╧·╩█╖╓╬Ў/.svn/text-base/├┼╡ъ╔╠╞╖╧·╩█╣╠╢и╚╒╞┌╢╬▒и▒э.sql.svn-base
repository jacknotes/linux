...
begin
  ...
  insert into hdtmp_SalDrpt(cls,orgkey,pdkey,vdrkey,brdkey,fildate,
    ...
    select null,r.orgkey,r.pdkey,v.gid,b.code,vdate,
    ...
    from rpt_storesaldrpt r,goodsh g,brand b,vendorh v,store s
    where r.pdkey = g.gid 
      and g.brand = b.code(+)
      ...
      and r.fildate = vdate
      and s.code like vstorecode
    group by r.orgkey,r.pdkey,v.gid,b.code;
  
    insert into hdtmp_SalDrpt(cls,orgkey,pdkey,vdrkey,brdkey,fildate,
                            saleqty,saleamt,saletax,salecamt,salectax)
     select null,r.snd,r.gdgid,null,null,vdate,
    ...
    from sdrpts r,goodsh g,store s,brand b,vendorh v
    where r.gdgid = g.gid 
      and r.snd = s.gid 
      and g.brand = b.code(+)
