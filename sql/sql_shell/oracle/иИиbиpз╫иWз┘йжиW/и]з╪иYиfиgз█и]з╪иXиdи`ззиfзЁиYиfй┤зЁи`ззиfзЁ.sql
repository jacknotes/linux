...
begin
  ...
  insert into tmp_test2
    ...
    select vendor.code,
           vendor.name,
           CNTRPAYCASH.NUM,
           CNTRPAYCASH.PAYTOTAL,
           CNTRPAYCASHCHKLOG.ATIME,
           to_date(Emddate, 'yyyy-mm-dd') ----统计日期
      from CNTRPAYCASH, CNTRPAYCASHCHKLOG,vendor
     where CNTRPAYCASH.stat = 900
       and CNTRPAYCASH.Num = CNTRPAYCASHCHKLOG.NUM
       and CNTRPAYCASHCHKLOG.CHKFLAG = 900
       and CNTRPAYCASHCHKLOG.ATIME <= to_date(Emddate, 'yyyy-mm-dd') + 1
       and CNTRPAYCASH.Vdrgid=vendor.gid
