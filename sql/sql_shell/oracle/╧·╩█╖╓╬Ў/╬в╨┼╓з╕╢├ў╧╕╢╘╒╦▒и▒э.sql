...
--删除冲账的原单
  ...
  insert into h4rtmp_alipaycheckline(bdate,edate,scode,sname,posno,flowno,amount1,amount2,targetnum,type,flag)
         select vbdate,vedate-1,b.scode,b.sname,a.posno,a.flowno,a.amount,b.amount,b.targetnum,b.type,nvl(a.amount,'0')-nvl(b.amount,'0') flag
...
<TABLELIST>
  ...
  <TABLEITEM>
    <TABLE>weixinpayrecord</TABLE>
    <ALIAS>weixinpayrecord</ALIAS>
    <INDEXNAME></INDEXNAME>
    <INDEXMETHOD></INDEXMETHOD>
  </TABLEITEM>
</TABLELIST>
<JOINLIST>
  ...
  <JOINITEM>
    <LEFT>weixinpayrecord.transactionid</LEFT>
    <OPERATOR>=</OPERATOR>
    <RIGHT>h4rtmp_alipaycheckline.targetnum</RIGHT>
  </JOINITEM>
</JOINLIST>
<COLUMNLIST>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>h4rtmp_alipaycheckline.sname</COLUMN>
    <TITLE>门店名称</TITLE>
    <FIELDTYPE>1</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>weixinpayrecord.paytimeend</COLUMN>
    <TITLE>微信支付日期</TITLE>
    <FIELDTYPE>0</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR>>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2016.04.14</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR><</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2016.04.15</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2016.04.14</SGLINEITEM>
    <SGLINEITEM>2016.04.15</SGLINEITEM>
...
<CHECKLIST>
  <CAPTION>
    <CAPTIONITEM>只看差异</CAPTIONITEM>
  </CAPTION>
  <EXPRESSION>
    <EXPRESSIONITEM>flag<>'0'</EXPRESSIONITEM>
  </EXPRESSION>
  <CHECKED>
