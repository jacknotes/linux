...
begin
  ...
  insert into hdtmp_SalDrpt(cls,orgkey,pdkey,vdrkey,brdkey,fildate,
   ...
   update hdtmp_SalDrpt t set t.zbbusqty = (select b.qty from businvs b where b.gdgid = t.pdkey and b.store = 1000000 and b.wrh = 1000000)
   where exists (select 1 from businvs where gdgid = t.pdkey and store = 1000000 and wrh = 1000000);  
   commit;
...
hdtmp_SalDrpt.salectax))/sum(hdtmp_SalDrpt.saleamt + hdtmp_SalDrpt.saletax) * 100 )
    </COLUMN>
    <TITLE>毛利率</TITLE>
    <FIELDTYPE>6</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR>>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2011.12.01</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
  ...
  <CRITERIAITEM>
    <LEFT>'['||h4v_goodsbrand.dscode||']'||h4v_goodsbrand.dsname</LEFT>
    <OPERATOR>LIKE</OPERATOR>
    <RIGHT>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2011.12.01</SGLINEITEM>
