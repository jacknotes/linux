...
<JOINLIST>
  ...
  <JOINITEM>
    <LEFT>GDSALESCHEME.CODE</LEFT>
    <OPERATOR>=</OPERATOR>
    <RIGHT>store.gdsalescheme</RIGHT>
  </JOINITEM>
  <JOINITEM>
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <PICKVALUE>
      <PICKVALUEITEM>SELECT CODE,CODE||'-'||NAME FROM STORE WHERE STAT = 0 AND CODE<>'9800' ORDER BY CODE</PICKVALUEITEM>
...
<CRITERIAWIDTH>
  <CRITERIAWIDTHITEM>155</CRITERIAWIDTHITEM>
  <CRITERIAWIDTHITEM>204</CRITERIAWIDTHITEM>
