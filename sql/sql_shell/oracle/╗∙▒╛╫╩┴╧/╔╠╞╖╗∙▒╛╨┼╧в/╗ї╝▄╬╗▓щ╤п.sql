...
[临时表结构]
CREATE OR REPLACE VIEW V_SLOT_GOODS AS
SELECT
WAREHOUSEH.CODE,
'['||WAREHOUSEH.CODE||']'||WAREHOUSEH.NAME name11,
DA_SLOT_GROUP.REGIONCODE REGIONCODE1,
DA_SLOT_GROUP.SLOTGRP SLOTGRP1,
 DA_SLOT_GROUP.SLOTCODE SLOTCODE1,
  GOODS.CODE GDCODE,
GOODS.NAME NAME,
GOODS.CODE2 CODE2,
GOODS.SORT SORT
FROM GOODS GOODS, DC_SLOT_REGION DC_SLOT_REGION, DA_SLOT_GROUP DA_SLOT_GROUP, 
WAREHOUSEH WAREHOUSEH
WHERE ((DA_SLOT_GROUP.SLOTCODE = GOODS.SLOT(+))
   and  (DA_SLOT_GROUP.REGIONCODE = DC_SLOT_REGION.CODE)
   and  (DC_SLOT_REGION.WRH = WAREHOUSEH.GID(+)) )
ORDER BY GDCODE ASC;
[版本记录] 
20101003/LINING
[其它]
...
begin
  ...
  insert into tmp_test2 (char1,int1)
    select max(gdinput.code) code, gdinput.gid
      from GDQPC, gdinput
     where GDQPC.Gid = gdinput.gid
       and GDQPC.QPCSTR = gdinput.qpcstr
       and GDQPC.isdu = 2
     group by gdinput.gid;
commit;
end;
</BEFORERUN>
<AFTERRUN>
...
<JOINLIST>
  <JOINITEM>
    <LEFT>v_slot_goods.GDGID</LEFT>
    <OPERATOR>=</OPERATOR>
    <RIGHT>GDQPC.GID(+)</RIGHT>
  </JOINITEM>
  <JOINITEM>
    <LEFT>GDQPC.ISPU(+)</LEFT>
    <OPERATOR>=</OPERATOR>
    <RIGHT>2</RIGHT>
  </JOINITEM>
  <JOINITEM>
...
<COLUMNLIST>
  ...
  <COLUMNITEM>
    ...
    <COLUMN>V_SLOT_GOODS.CODE</COLUMN>
    <TITLE>仓位</TITLE>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>V_SLOT_GOODS.name11</COLUMN>
    <TITLE>仓位名称</TITLE>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>V_SLOT_GOODS.REGIONCODE1</COLUMN>
    <TITLE>货区</TITLE>
    <FIELDTYPE>1</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
    <DISPLAYINNEXT>TRUE</DISPLAYINNEXT>
    <ISKEY>FALSE</ISKEY>
    <COLUMNNAME>REGIONCODE11</COLUMNNAME>
    <CFILTER>FALSE</CFILTER>
    <CFONTCOLOR>0</CFONTCOLOR>
    <CDISFORMAT></CDISFORMAT>
    <CGROUPINDEX>-1</CGROUPINDEX>
  ...
  <COLUMNITEM>
    ...
    <DISPLAYINNEXT>TRUE</DISPLAYINNEXT>
    <ISKEY>FALSE</ISKEY>
    <COLUMNNAME>SLOTGRP11</COLUMNNAME>
    <CFILTER>FALSE</CFILTER>
    <CFONTCOLOR>0</CFONTCOLOR>
    <CDISFORMAT></CDISFORMAT>
    <CGROUPINDEX>-1</CGROUPINDEX>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>V_SLOT_GOODS.SLOTCODE1</COLUMN>
    <TITLE>货位</TITLE>
    <FIELDTYPE>1</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
    <DISPLAYINNEXT>TRUE</DISPLAYINNEXT>
    <ISKEY>FALSE</ISKEY>
    <COLUMNNAME>SLOTCODE11</COLUMNNAME>
    <CFILTER>FALSE</CFILTER>
    <CFONTCOLOR>0</CFONTCOLOR>
    <CDISFORMAT></CDISFORMAT>
    <CGROUPINDEX>-1</CGROUPINDEX>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>V_SLOT_GOODS.GDCODE</COLUMN>
    <TITLE>商品代码</TITLE>
    <FIELDTYPE>1</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>V_SLOT_GOODS.NAME</COLUMN>
    <TITLE>商品名称</TITLE>
    <FIELDTYPE>1</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>V_SLOT_GOODS.CODE2</COLUMN>
    <TITLE>条形码</TITLE>
    <FIELDTYPE>1</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>V_SLOT_GOODS.SORT</COLUMN>
    <TITLE>类别代码</TITLE>
    <FIELDTYPE>1</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>V_SLOT_GOODS.ALC</COLUMN>
    <TITLE>配货方式</TITLE>
    <FIELDTYPE>1</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    <LEFT>V_SLOT_GOODS.REGIONCODE1</LEFT>
    <OPERATOR>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
  ...
  <CRITERIAITEM>
    <LEFT>V_SLOT_GOODS.SLOTGRP1</LEFT>
    <OPERATOR>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
  ...
  <CRITERIAITEM>
    <LEFT>V_SLOT_GOODS.SLOTCODE1</LEFT>
    <OPERATOR>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
...
<CHECKLIST>
  <CAPTION>
    <CAPTIONITEM>未维护商品</CAPTIONITEM>
  </CAPTION>
  <EXPRESSION>
    <EXPRESSIONITEM>GDCODE is null</EXPRESSIONITEM>
  </EXPRESSION>
  <CHECKED>
