...
begin
  ...
  insert into tmp_test2
    ...
    select area.name, ---区域
           ...
           Sor.cscode, ---小类
           Sor.csname, ---小类名称
           count(distinct A.Gdgid) SkuNum, ---SKU数
     ...
     and (Subcalss is null or Sor.cscode=Subcalss)
     and (Codec is null or S.code=Codec)
     and bv.QTY>0
     group by area.name,
              S.Province,
              Sor.ascode,
...
<COLUMNLIST>
  ...
  <COLUMNITEM>
    <AGGREGATION>SUM</AGGREGATION>
    <COLUMN>tmp_test2.int2*tmp_test2.Num1</COLUMN>
    <TITLE>在店库存额</TITLE>
    <FIELDTYPE>6</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION>SUM</GAGGREGATION>
...
tmp_test2.int2*tmp_test2.Num1*100/ tmp_test1.int2 end</COLUMN>
    <TITLE>库存额占比</TITLE>
    <FIELDTYPE>6</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION>SUM</GAGGREGATION>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>case when tmp_test2.int3=0 then 0 else tmp_test2.int4*100/tmp_test2.int3-1 end</COLUMN>
    <TITLE>周销量环比</TITLE>
    <FIELDTYPE>6</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
...
tmp_test2.Num3*100/tmp_test1.int6 end</COLUMN>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN>case when tmp_test2.Num2=0 then 0 else tmp_test2.Num3*100/tmp_test2.Num2-1 end</COLUMN>
    <TITLE>周销售额环比</TITLE>
    <FIELDTYPE>6</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION></GAGGREGATION>
...
<CRITERIALIST>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR>>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2016.08.14</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR><=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2016.08.20</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR>>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2016.08.21</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR><=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2016.08.27</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2016.08.14</SGLINEITEM>
    <SGLINEITEM>2016.08.20</SGLINEITEM>
    <SGLINEITEM>2016.08.21</SGLINEITEM>
    <SGLINEITEM>2016.08.27</SGLINEITEM>
