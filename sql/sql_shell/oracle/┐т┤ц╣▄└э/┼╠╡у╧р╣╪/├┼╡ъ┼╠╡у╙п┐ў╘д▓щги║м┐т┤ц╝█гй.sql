...
<JOINLIST>
  ...
  <JOINITEM>
    ...
    <OPERATOR>=</OPERATOR>
    <RIGHT>CKDataS.STORE</RIGHT>
  </JOINITEM>
  <JOINITEM>
    <LEFT>ACTINVS.GDGID</LEFT>
    <OPERATOR>=</OPERATOR>
    <RIGHT>CKDataS.GDGID</RIGHT>
  </JOINITEM>
  <JOINITEM>
...
<COLUMNLIST>
  ...
  <COLUMNITEM>
    <AGGREGATION></AGGREGATION>
    <COLUMN> CKDataS.QTY  *  ACTINVS.INVPRC </COLUMN>
    <TITLE>实盘成本金额</TITLE>
    <FIELDTYPE>6</FIELDTYPE>
    <VISIBLE>TRUE</VISIBLE>
    <GAGGREGATION>SUM</GAGGREGATION>
