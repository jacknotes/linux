...
(
      ...
      ,num3           --盘盈数
      ,num4           --盘盈成本金额
      ,num7           --盘盈零售金额 增加时间20170512 吴琼
      ,num5           --盘亏数
      ,num6           --盘亏成本金额
      ,num8           --盘亏零售金额 增加时间20170512 吴琼
      ,date1          --查询开始日期
      ,date2          --查询结束日期
      ,char9          --品牌
)
...
select store.gid gid
      ,store.code code
      ,store.name name
      ,case when sort.code in ('10','11','12','13','15','16','17','18','19','40','42','43','44','45','46','47','48','49','50') then '日用百货类'
            when sort.code in ('14','41') then '食品类'
      ...
      ,(CKDataS.QTY - CKDataS.ACNTQTY)*CKDataS.RTLPRC pysje--盘盈售价金额
      ,0 pks
      ,0 pkje
      ,0 pksje
      ,goods.brand goodsbrand --于20170616日添加品牌字段
...
where store.gid = CKDataS.Store
  ...
  and CKDataS.stat=3   ---侯云松2015-9-14 增加过滤状态 已完成
...
select store.gid gid
      ...
      ,(CKDataS.QTY - CKDataS.ACNTQTY)*CKDataS.RTLPRC pksje --盘亏售价金额
      ,goods.brand  goodsbrand--于20170616日添加品牌字段
from store , CKDataS , goods ,sort
where store.gid = CKDataS.Store
  and CKDataS.Gdgid = goods.gid
  ...
  and CKDataS.stat=3 ---侯云松2015-9-14 增加过滤状态 已完成
           ...
           ,goodscode
           ,goodscode2
           ,goodsname,goodsbrand --于20170616日添加品牌字段       
   order by code ;        
