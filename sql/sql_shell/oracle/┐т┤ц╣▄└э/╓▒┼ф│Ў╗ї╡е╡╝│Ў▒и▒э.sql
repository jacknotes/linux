    ...
    select AA.*,
      ...
      from (SELECT STKO.SETTLENO,--期号
             ...
             WHERE STKOD.CLS = A.SRCCLS(+)
               ...
               --AND STKOD.NUM = '88881612050128'
               --AND STKOD.NUM = Codec
                   --
              and STKO.Settleno=SETTLENOA         
              and ST1.GID=(select gid from store where code=CodeM)
               and STKOD.QTY <> 0
               AND GGB.GID = GDH.GID
               AND GGB.ISPU = 2
