...
select '['||code||']'||name name1,name from sort where length(code)=2 and code like '1%'</PICKVALUEITEM>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR>>=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2017.12.04</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
  ...
  <CRITERIAITEM>
    ...
    <OPERATOR><=</OPERATOR>
    <RIGHT>
      <RIGHTITEM>2017.12.10</RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
      <RIGHTITEM></RIGHTITEM>
    </RIGHT>
...
<SG>
  ...
  <LINE>
    ...
    <SGLINEITEM>2017.12.04</SGLINEITEM>
    <SGLINEITEM>2017.12.10</SGLINEITEM>
    <SGLINEITEM></SGLINEITEM>
    <SGLINEITEM>星辰</SGLINEITEM>
  </LINE>
  <LINE>
