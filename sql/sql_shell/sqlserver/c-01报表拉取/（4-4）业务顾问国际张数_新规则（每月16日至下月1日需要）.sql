...
where  (datetime BETWEEN '2018-05-01 00:00:00' AND '2018-05-31 23:59:59') and sales<>''  and inf=0 and tickettype in ('电子票','婴儿票','团队定金')
...
where  (datetime BETWEEN '2018-05-01 00:00:00' AND '2018-05-31 23:59:59') and SpareTC<>'' AND SpareTC<>sales and cmpcode<>''  and inf=0  and tickettype in ('电子票','婴儿票','团队定金')
...
INTO #gj
FROM ( SELECT sales,cmpcode,SUM(CASE WHEN totprice=0 THEN 0  WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END) AS Num,SUM(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * totprice) AS totprice,sum(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * Mcost) as Mcost,SUM(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * price) AS price,  SUM(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * profit)  AS profit, SUM(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * isnull(Subsidies,0))  AS Subsidy FROM tbcash left join tbCompanyM on tbcash.cmpcode=tbCompanyM.cmpid 
where  (datetime BETWEEN '2018-05-01 00:00:00' AND '2018-05-31 23:59:59') and sales<>''  and inf=1 and tickettype in ('电子票','婴儿票','团队定金')
GROUP BY sales,cmpcode  
UNION ALL SELECT SpareTC AS sales,cmpcode,SUM(CASE WHEN totprice=0 THEN 0 ELSE 0.50 END) AS Num,SUM(0.50 * totprice) AS totprice,sum(0.50 * Mcost) as Mcost,SUM(0.50 * price) AS price,  SUM(0.50 * profit)  AS profit, SUM(0.50 * isnull(Subsidies,0))  AS Subsidy FROM tbcash left join tbCompanyM on tbcash.cmpcode=tbCompanyM.cmpid 
where  (datetime BETWEEN '2018-05-01 00:00:00' AND '2018-05-31 23:59:59') and SpareTC<>'' AND SpareTC<>sales and cmpcode<>''  and inf=1 and tickettype in ('电子票','婴儿票','团队定金')
...
FROM (
	...
	tbReti.ExamineDate BETWEEN '2018-05-01 00:00:00' AND '2018-05-31 23:59:59'
...
into #gj_xuanwei
FROM ( SELECT sales,cmpcode,SUM(CASE WHEN totprice=0 THEN 0  WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END) AS Num,SUM(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * totprice) AS totprice,sum(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * Mcost) as Mcost,SUM(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * price) AS price,  SUM(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * profit)  AS profit, SUM(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * isnull(Subsidies,0))  AS Subsidy FROM tbcash left join tbCompanyM on tbcash.cmpcode=tbCompanyM.cmpid 
where  (datetime BETWEEN '2018-05-01 00:00:00' AND '2018-05-31 23:59:59') and sales<>''  and inf=1 and reti='' and tickettype in ('电子票','婴儿票','团队定金') and route like ('%选位%') and coupno not in (SELECT coupno FROM dbo.tbinvalid WHERE type in (0,1)) and tcode+'-'+ticketno not in (SELECT ticketno FROM dbo.tbinvalid WHERE type in (0,1))
...
into #gj_chunlirun
FROM ( SELECT sales,cmpcode,SUM(CASE WHEN totprice=0 THEN 0  WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END) AS Num,SUM(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * totprice) AS totprice,sum(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * Mcost) as Mcost,SUM(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * price) AS price,  SUM(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * profit)  AS profit, SUM(CASE WHEN cmpcode<>''and SpareTC<>'' AND SpareTC<>sales THEN 0.50 else 1 END * isnull(Subsidies,0))  AS Subsidy FROM tbcash left join tbCompanyM on tbcash.cmpcode=tbCompanyM.cmpid 
where  (datetime BETWEEN '2018-05-01 00:00:00' AND '2018-05-31 23:59:59') and sales<>''  and inf=1 and reti='' and tickettype in ('电子票','婴儿票','团队定金') and t_source like ('%纯利润I%') and coupno not in (SELECT coupno FROM dbo.tbinvalid WHERE type in (0,1)) and tcode+'-'+ticketno not in (SELECT ticketno FROM dbo.tbinvalid WHERE type in (0,1))
...
where  
--c.datetime BETWEEN '2018-05-01 00:00:00' AND '2018-05-31 23:59:59' and 
r.ExamineDate BETWEEN '2018-05-01 00:00:00' AND '2018-05-31 23:59:59'
and c.inf=1
and reti<>''
...
--LEFT join tbCompanyM on tbcash.cmpcode=tbCompanyM.cmpid 
--INNER JOIN (SELECT coupno,ticketno FROM dbo.tbinvalid WHERE type=1) Inv ON inv.coupno=tbcash.coupno AND inv.ticketno LIKE '%'+tbcash.tcode+'-'+tbcash.ticketno+'%' 
--WHERE dbo.tbcash.totprice>0 and (datetime BETWEEN '2018-05-01 00:00:00' AND '2018-05-31 23:59:59') and sales<>''  and inf=1
--ORDER BY sales
...
--LEFT join tbCompanyM on tbcash.cmpcode=tbCompanyM.cmpid 
--INNER JOIN (SELECT coupno,ticketno FROM dbo.tbinvalid WHERE type=1) Inv ON inv.coupno=tbcash.coupno AND inv.ticketno LIKE '%'+tbcash.tcode+'-'+tbcash.ticketno+'%' 
--WHERE dbo.tbcash.totprice>0 and (datetime BETWEEN '2018-05-01 00:00:00' AND '2018-05-31 23:59:59') and sales<>''  and inf=1 GROUP BY sales,cmpcode  UNION ALL SELECT SpareTC AS sales,cmpcode,SUM(CASE WHEN totprice=0 THEN 0 ELSE 0.50 END) AS Num,SUM(0.50 * totprice) AS totprice,sum(0.50 * Mcost) as Mcost,SUM(0.50 * price) AS price,  SUM(0.50 * profit)  AS profit, SUM(0.50 * isnull(Subsidies,0))  AS Subsidy FROM tbcash left join tbCompanyM on tbcash.cmpcode=tbCompanyM.cmpid INNER JOIN (SELECT coupno,ticketno FROM dbo.tbinvalid WHERE type=1) Inv ON inv.coupno=tbcash.coupno AND inv.ticketno LIKE '%'+tbcash.tcode+'-'+tbcash.ticketno+'%'  where  (datetime BETWEEN '2018-05-01 00:00:00' AND '2017-01-28 23:59:59') and SpareTC<>'' AND SpareTC<>sales and cmpcode<>''  and inf=1 GROUP BY SpareTC,cmpcode  ) T GROUP BY sales,cmpcode order by sales,cmpcode
