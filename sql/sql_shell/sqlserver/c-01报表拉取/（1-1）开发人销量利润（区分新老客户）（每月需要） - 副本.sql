...
--请按开发人（'HOMSOM','陈亦婷','范文涛','胡启霏','楼兆罡','陆乐','马骏','钱佳辉','邱海平','孙唯一','王涛','张俊','郑磊','郭依','张广寒','彭永飞','沈正邦','崔之阳','龚静','黄丽蓉','李一帆','奚秀兰','徐勇','张怡'），拉取新老客户的总销量、总利润（机票、酒店、旅游、会务、火车票）
--新老客户以2017年1月1日为界限（1月1日前为老客户）
...
from #cmp1
where 单位编号<>''
and 开发人 in  ('HOMSOM','陈亦婷','范文涛','胡启霏','楼兆罡','陆乐','马骏','钱佳辉','邱海平','孙唯一','王涛','张俊','郑磊','郭依','张广寒','彭永飞','沈正邦','崔之阳','龚静','黄丽蓉','李一帆','奚秀兰','徐勇','张怡')
...
into #ta
from #kfr t1
left join #jipiao_old jo on jo.开发人=t1.开发人 
order by t1.开发人
--新客户
select 
t1.开发人
...
into #tb
from #kfr t1
left join #jipiao_new jo on jo.开发人=t1.开发人 
order by t1.开发人
...
into #ha
from #kfr t1
left join #hotel_old jo on jo.开发人=t1.开发人 
order by t1.开发人
--新客户
select 
t1.开发人
...
into #hb
from #kfr t1
left join #hotel_new jo on jo.开发人=t1.开发人 
order by t1.开发人
...
into #za
from #kfr t1
left join #hotel_old_y jo on jo.开发人=t1.开发人 
order by t1.开发人
--新客户
select 
t1.开发人
...
into #zb
from #kfr t1
left join #hotel_new_y jo on jo.开发人=t1.开发人 
order by t1.开发人
...
into #la
from #kfr t1
left join #trv_old jo on jo.开发人=t1.开发人 
order by t1.开发人
--新客户
select 
t1.开发人
...
into #lb
from #kfr t1
left join #trv_new jo on jo.开发人=t1.开发人 
order by t1.开发人
...
into #ca
from #kfr t1
left join #con_old jo on jo.开发人=t1.开发人 
order by t1.开发人
--新客户
select 
t1.开发人
...
into #cb
from #kfr t1
left join #con_new jo on jo.开发人=t1.开发人 
order by t1.开发人
...
into #fa
from #kfr t1
left join #train_old jo on jo.开发人=t1.开发人 
order by t1.开发人
--新客户
select 
t1.开发人
...
into #fb
from #kfr t1
left join #train_new jo on jo.开发人=t1.开发人 
order by t1.开发人
...
from #kfr kfr
left join #ta ta on ta.开发人=kfr.开发人
left join #tb tb on tb.开发人=kfr.开发人
left join #ha ha on ha.开发人=kfr.开发人
left join #hb hb on hb.开发人=kfr.开发人
left join #za za on za.开发人=kfr.开发人
left join #zb zb on zb.开发人=kfr.开发人
left join #la la on la.开发人=kfr.开发人
left join #lb lb on lb.开发人=kfr.开发人
left join #ca ca on ca.开发人=kfr.开发人
left join #cb cb on cb.开发人=kfr.开发人
left join #fa fa on fa.开发人=kfr.开发人
left join #fb fb on fb.开发人=kfr.开发人