...
SELECT    @toybishu=COUNT(*),@totprice=SUM(price)
          ...
          WHERE     ( cmpcode = '016448' )
                    ...
                    --and ISNULL(cabintype,'经济舱') in ('头等舱','公务舱')
...
select case diffday when 1 then '0-6' when 2 then '7-13' when 3 then '14-20' when 4 then '21-27' when 5 then '大于28' else '' end as 提前出票天数
