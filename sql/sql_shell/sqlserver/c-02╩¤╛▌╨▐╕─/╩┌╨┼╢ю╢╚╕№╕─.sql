--查询
--账单表
SELECT     CompanyCode as 单位编号,BillNumber as 账单号,SX_BaseCreditLine as 授信额度,SX_AppendCreditLine as 附加额度
...
WHERE     (CompanyCode = '单位编号') 
ORDER BY BillNumber DESC       --按账单号倒排序，一般默认第一条
