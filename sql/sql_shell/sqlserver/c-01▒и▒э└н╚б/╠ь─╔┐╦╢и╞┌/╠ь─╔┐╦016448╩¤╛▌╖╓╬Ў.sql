...
select Department,SUM(price) as 销量,COUNT(*) as 张数,SUM(price)/COUNT(*) as 平均票价,AVG(CASE WHEN ISNULL(priceinfo,0)=0 THEN 0 ELSE	price/priceinfo END) AS zkpercent
,AVG(DATEDIFF(day,datetime,t1.begdate)) as 平均出票天数
--into #t1
