...
from #cmp1
where 单位编号<>''
and (开发人 in (select empname 
from Emppwd where dep ='市场营销部')
or (开发人 in (select empname 
from EmpDismission where dep ='市场营销部'))
)
...
where t1.indate>='2018-04-01'
and (t3.datetime>='2018-04-01' and t3.datetime<'2018-07-01')
and 单位编号<>''
group by t1.开发人
order by t1.开发人
...
where t1.indate>='2018-04-01' and
(h1.prdate>='2018-04-01' and h1.prdate<'2018-07-01') and 
status !='-2'
and 单位编号<>''
group by t1.开发人
order by t1.开发人
...
where t1.indate>='2018-04-01' and
(h3.datetime>='2018-04-01' and h3.datetime<'2018-07-01') and 
status !='-2'
and 单位编号<>''
group by t1.开发人
order by t1.开发人
...
where t1.indate>='2018-04-01' and
 (l1.OperDate>='2018-04-01' and l1.OperDate<'2018-07-01')
and 单位编号<>''
group by t1.开发人
order by t1.开发人
...
where t1.indate>='2018-04-01' and
 (c1.OperDate>='2018-04-01' and c1.OperDate<'2018-07-01')
and 单位编号<>''
group by t1.开发人
order by t1.开发人
...
where t1.indate>='2018-04-01' and
(trainO.CreateDate>='2018-04-01' and trainO.CreateDate<'2018-07-01')
and (r.AuditTime >='2018-04-01' AND r.AuditTime<'2018-07-01')
