...
select cmp1.*,ac.SX_BaseCreditLine as 固定额度,SX_TomporaryCreditLine as 追加额度 from #cmp1 cmp1
left join AccountStatement ac on cmp1.单位编号=ac.CompanyCode and ac.AccountPeriodAir1>='2018-03-26'
where 单位名称 like ('%新能源%')