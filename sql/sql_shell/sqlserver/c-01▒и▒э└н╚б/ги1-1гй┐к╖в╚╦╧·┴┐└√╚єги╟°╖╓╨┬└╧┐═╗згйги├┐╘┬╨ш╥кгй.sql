...
--请按开发人（谈嘉巍、沈正邦、马骏、胡启霏、王绅元、楼兆罡、范文涛、彭庆华、彭永飞、万方、姜从余），拉取新老客户的总销量、总利润（机票、酒店、旅游、会务、火车票）
...
from #cmp1
where 单位编号<>''
and 开发人 in  ('谈嘉巍','沈正邦','蔡宗一','徐寒醒','卞森泉','马骏','胡启霏','楼兆罡','范文涛','彭永飞','万方','钱佳辉','袁捷','徐佳亮','王绅元','陆乐','薛晨飞','魏浩宸','姜涛')
