...
--维护人
IF OBJECT_ID('tempdb.dbo.#cmp') IS NOT NULL DROP TABLE #whr
select distinct 维护人 
into #whr
from #cmp1
where 单位编号<>''
...
where 
(h3.datetime>='2016-01-01' and h3.datetime<'2017-01-01') and 
status !='-2'
and 单位编号<>''
group by t1.维护人
order by t1.维护人
...
where 
 (l1.OperDate>='2016-01-01' and l1.OperDate<'2017-01-01')
and 单位编号<>''
group by t1.维护人
order by t1.维护人
...
where 
 (c1.OperDate>='2016-01-01' and c1.OperDate<'2017-01-01')
and 单位编号<>''
group by t1.维护人
order by t1.维护人
...
where 
(trainO.CreateDate>='2016-01-01' and trainO.CreateDate<'2017-01-01')
and (r.AuditTime >='2016-01-01' AND r.AuditTime<'2017-01-01')
...
select whr.维护人
,tb1+hb1+zb1+lb1+cb1+fb1 as 客户总销量
,tb2+hb2+zb2+lb2+cb2+fb2 as 客户总利润
,tb.tb1 as 客户机票销量,tb.tb2 as 客户机票利润
,hb.hb1 as 客户预付酒店销量,hb.hb2 as 客户预付酒店利润
,zb.zb1 as 客户自付酒店销量,zb.zb2 as 客户自付酒店利润
,lb.lb1 as 客户旅游销量,lb.lb2 as 客户旅游利润
,cb.cb1 as 客户会务销量,cb.cb2 as 客户会务利润
,fb.fb1 as 客户火车票销量,fb.fb2 as 客户火车票利润
from #whr whr
