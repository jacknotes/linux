...
IF OBJECT_ID('tempdb.dbo.#yyjl1') IS NOT NULL DROP TABLE #yyjl1
select distinct 运营经理 
into #yyjl1
from #cmp
where 运营经理 in ('劳黎黎','施慧君','邵雪梅')
...
and (t3.datetime>='2018-07-01' and t3.datetime<'2018-08-01')
and 单位编号<>''
group by t1.运营经理
order by t1.运营经理
...
into #ta
from #yyjl1 t1
left join #jipiao_old jo on jo.运营经理=t1.运营经理 
order by t1.运营经理
--新客户
select 
t1.运营经理
...
into #tb
from #yyjl1 t1
left join #jipiao_new jo on jo.运营经理=t1.运营经理 
order by t1.运营经理
...
(h1.prdate>='2018-07-01' and h1.prdate<'2018-08-01') and 
status !='-2'
and 单位编号<>''
group by t1.运营经理
order by t1.运营经理
...
into #ha
from #yyjl1 t1
left join #hotel_old jo on jo.运营经理=t1.运营经理 
order by t1.运营经理
--新客户
select 
t1.运营经理
...
into #hb
from #yyjl1 t1
left join #hotel_new jo on jo.运营经理=t1.运营经理 
order by t1.运营经理
...
where t1.indate<'2018-01-01' and
(h3.datetime>='2018-07-01' and h3.datetime<'2018-08-01') and 
status !='-2'
and 单位编号<>''
group by t1.运营经理
order by t1.运营经理
...
into #za
from #yyjl1 t1
left join #hotel_old_y jo on jo.运营经理=t1.运营经理 
order by t1.运营经理
--新客户
select 
t1.运营经理
...
into #zb
from #yyjl1 t1
left join #hotel_new_y jo on jo.运营经理=t1.运营经理 
order by t1.运营经理
...
where t1.indate<'2018-01-01' and
 (l1.OperDate>='2018-07-01' and l1.OperDate<'2018-08-01')
and 单位编号<>''
group by t1.运营经理
order by t1.运营经理
...
into #la
from #yyjl1 t1
left join #trv_old jo on jo.运营经理=t1.运营经理 
order by t1.运营经理
--新客户
select 
t1.运营经理
...
into #lb
from #yyjl1 t1
left join #trv_new jo on jo.运营经理=t1.运营经理 
order by t1.运营经理
...
where t1.indate<'2018-01-01' and
 (c1.OperDate>='2018-07-01' and c1.OperDate<'2018-08-01')
and 单位编号<>''
group by t1.运营经理
order by t1.运营经理
...
into #ca
from #yyjl1 t1
left join #con_old jo on jo.运营经理=t1.运营经理 
order by t1.运营经理
--新客户
select 
t1.运营经理
...
into #cb
from #yyjl1 t1
left join #con_new jo on jo.运营经理=t1.运营经理 
order by t1.运营经理
...
where t1.indate<'2018-01-01' and
(trainO.CreateDate>='2018-07-01' and trainO.CreateDate<'2018-08-01')
and (r.AuditTime >='2018-07-01' AND r.AuditTime<'2018-08-01')
...
into #fa
from #yyjl1 t1
left join #train_old jo on jo.运营经理=t1.运营经理 
order by t1.运营经理
--新客户
select 
t1.运营经理
...
into #fb
from #yyjl1 t1
left join #train_new jo on jo.运营经理=t1.运营经理 
order by t1.运营经理
...
from #yyjl1 yyjl1
left join #ta ta on ta.运营经理=yyjl1.运营经理
left join #tb tb on tb.运营经理=yyjl1.运营经理
left join #ha ha on ha.运营经理=yyjl1.运营经理
left join #hb hb on hb.运营经理=yyjl1.运营经理
left join #za za on za.运营经理=yyjl1.运营经理
left join #zb zb on zb.运营经理=yyjl1.运营经理
left join #la la on la.运营经理=yyjl1.运营经理
left join #lb lb on lb.运营经理=yyjl1.运营经理
left join #ca ca on ca.运营经理=yyjl1.运营经理
left join #cb cb on cb.运营经理=yyjl1.运营经理
left join #fa fa on fa.运营经理=yyjl1.运营经理
left join #fb fb on fb.运营经理=yyjl1.运营经理